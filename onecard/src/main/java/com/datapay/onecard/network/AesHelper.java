...
public class AesHelper {
     ...
     * @return
     */
    public static byte[] MD5Encode(String strSrc, String key) {
        MessageDigest md5;
     ...
     * @return
     */
    public static byte[] crypt(byte[] str, byte[] key, int mode) {
    ...
    public static String getEncryptBody(String body) {
        try {
            ...
            return dynamicKey + AesHelper.base64Encode(encrypt(body.getBytes(), AesHelper.MD5Encode(dynamicKey + SALT_KEY, "")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String getDecryptBody(String body) {
        try {
            return new String(AesHelper.decrypt(base64Decode(AesHelper.getData(body)), AesHelper.MD5Encode(AesHelper.getBodyDynamicKey(body) + SALT_KEY, "")));
        } catch (Exception e) {
            return "";
        }
    }
